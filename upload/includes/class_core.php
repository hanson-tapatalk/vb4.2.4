...
define('FILE_VERSION', '4.2.4'); // this should match installsteps.php
define('SIMPLE_VERSION', '424'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 92883 $
* @date		$Date: 2017-02-11 16:29:57 -0800 (Sat, 11 Feb 2017) $
*/
class vB_Database
{
	/**
	...
	*/
	function lock_tables($tablelist)
	{
		...
		{
			// Don't lock tables if we know we might get stuck with them locked (pconnect = true & using mysql)
			// Note that mysqli supports pconnect in php5.3+, but performs a cleanup on locks, so there is no issue
			// Since PHP 5.5+ only supports mysqli there is only a need to do this check where php is less than 5.5.0.
			if (version_compare(phpversion(), '5.5.0', '<')
				AND strtolower($this->registry->config['Database']['dbtype']) == 'mysql' 
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 05:01, Mon May 6th 2019 : $Revision: 92883 $
|| # $Date: 2017-02-11 16:29:57 -0800 (Sat, 11 Feb 2017) $
|| ####################################################################
\*======================================================================*/
